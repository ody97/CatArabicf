...
@catub.cat_cmd(
    ...
    info={
        ...
        "ملاحظة": "إذا كنت تريد اضافة اكثر من كلمة في امر واحد ، فتذكر أنه يجب إعطاء كلمة جديدة في سطر واحد ليس منع مرحبا هاي \n انما تقوم بمثل هذا ↫ منع مرحبا\nهاي",
...
@catub.cat_cmd(
    ...
    info={
        "عمل الملف": "لازالة كلمة ممنوعة من بياناتي",
        "وصف الملف": "ستتم إزالة الكلمة أو الكلمات المعينة من قائمة المنع في المحادثة المحددة",
        "ملاحظة": "اذا كنت تريد حذف اكثر من كلمة فـ يجب عليك اعطاء اكثر من سطر مثل : منع هلو\nهاي",
...
async def _(event):
    ...
    if len(all_blacklisted) > 0:
        ...
        OUT_STR = "**▾∮ لم تظف اي كلمة الى قائمة المنع\n استخدم `منع` **<الكلمة> ✎✓**"
